...
type ResultEvent struct {
	...
	Info model.Info `json:"info,inline" gorm:"-"`
	...
	ExtractedResults []string `json:"extracted-results,omitempty" gorm:"-"`
	...
	Metadata map[string]interface{} `json:"meta,omitempty" gorm:"-"`
	...
	Interaction *server.Interaction `json:"interaction,omitempty" gorm:"-"`
	...
	Lines []int `json:"matched-line,omitempty" gorm:"-"`

	FileToIndexPosition map[string]int `json:"-" gorm:"-"`
